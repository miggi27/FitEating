// frontend\src\constants\exercise.ts
// 1. 부위별 상세 운동 카테고리 정의
...
export const CATEGORY_ORDER = ["Stability", "ROM", "Movement Quality", "Posture", "Core"]
